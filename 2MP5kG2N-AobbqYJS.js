    ...
    var e, t, n = {
        ...
        5083: (e,t,n)=>{
            ...
            const u = {
              ...
              , p = function(e, t) {
                ...
                const C = v.playlist;
                if (C)
                    Array.isArray(C.playlist) && (v.feedData = C,
                    v.playlist = C.playlist);
                else {
                    const e = (0,
        ...
        8518: (e,t,n)=>{
            ...
            const k = (e,t,n)=>{
              ...
              , j = function(e) {
                return "boolean" == typeof j.mock_ ? j.mock_ : (0,
        ...
        1569: (e,t,n)=>{
            ...
            const o = function(e) {
              ...
              , s = function() {
                const e = "//pub-11ae963f793f40098944d2d13b0b1c4b.r2.dev/player_assets/";
                return `${e && (0,
        ...
        5882: (e,t,n)=>{
            ...
            const b = (e,t,n)=>{
              ...
              , O = (e,t,n,r)=>{
                c ? C(e, t, "pointerdown", n, r) : (u && C(e, t, "mousedown", n, r),
                C(e, t, "touchstart", n, r))
            }
              , E = e=>{
                if (e.handlers[h])
                    return;
                ...
                O(e, h, (n=>{
                    const {target: r} = n;
                    x(n) || Boolean(e.directSelect) && r !== t || (n.isPrimary && "BUTTON" === r.tagName && r.focus(),
                    e.lastStart = (0,
                    s.z)(),
                    e.clicking = !0)
                }
                ...
                C(e, h, "click", (n=>{
                    x(n) || Boolean(e.directSelect) && n.target !== t || ((0,
              ...
              , A = e=>{
                ...
                O(e, p, (i=>{
                    ...
                    "pointerdown" === c && i.isPrimary) {
                        ...
                        "mousedown" === c ? (C(e, d, "mousemove", o, r),
                        C(e, d, "mouseup", s)) : "touchstart" === c && (C(e, d, "touchmove", o, r),
                        C(e, d, "touchcancel", s),
                        C(e, d, "touchend", s))
                }
                ), r)
              ...
              , Z = {
                ...
                over(e) {
                    (c || u) && C(e, i.B1, c ? "pointerover" : "mouseover", (t=>{
                ...
                out(e) {
                    if (c) {
                        ...
                        u && C(e, i.U3, "mouseout", (t=>{
                            b(e, i.U3, t)
                        }
                        ))
                },
                move(e) {
                    (c || u) && C(e, i.tP, c ? "pointermove" : "mousemove", (t=>{
        ...
        2445: (e,t,n)=>{
            ...
            const g = e=>"string" == typeof e && /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(e)
              ...
              , k = function(e, t) {
                ...
                return c.__abSendDomainToFeeds && (j = c.playlist,
                /\.jwplatform.com|\.jwplayer.com/.test(j)) && (c.playlist = (C = c.playlist) + `${-1 !== C.indexOf("?") ? "&" : "?"}page_domain=${encodeURIComponent((0,
                f.X)())}`),
                c
            }
        }
        ...
        576: (e,t,n)=>{
            ...
            const x = e=>{
              ...
              , S = function(e) {
                ...
                t = x(n.id || n.getAttribute("data-jwplayer-id"))) : t = s.Z[0],
                t)
                    return t;
                if (n) {
                    const e = new P(n);
...
var jwDefaults = {
    ...
    "displaytitle": true,
    "height": 360,
    "key": "72TfNNjmw99IEyTpO3mS0UfRB9ueTyJBSPKIAO7V7yQZWlMDoVr+A80fMp4M1R4Z",
    "mute": false,
    "ph": 1,
    "pid": "KB5zFt7A",
